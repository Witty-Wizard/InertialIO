...
html_meta = {
    "description": "InertialIO | A serial communication library.",
    "author": "Witty-Wizard",
    "keywords": "InertialIO, serial communication, embedded systems, STM32, ESP32",
}

# -- Breathe configurations --------------------------------------------------
# Path to the generated Doxygen XML files
breathe_projects = {"InertialIO": "../xml"}
breathe_default_project = "InertialIO"
